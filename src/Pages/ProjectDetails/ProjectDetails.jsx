                ...
                <section className='py-32 overflow-hidden'>
                    <div className="container flex flex-col gap-28">
                        ...
                        <div className="flex flex-col gap-24">
                            <div className="flex flex-col gap-10 lg:mx-auto lg:w-3/4">
                                <h3 className="text-white font-Syne font-bold text-2xl lg:text-4xl">
                                    {proj.projectName}
                                </h3>
                                <ul className="flex items-center flex-wrap gap-6">
                                    {
                                        proj.usedTools.map((tool, index) => <li key={index} className="uppercase border border-white border-opacity-50 px-8 py-4 text-xs text-white">
                                            {tool}
                                        </li>)
                                    }
                                </ul>
                            ...
                            <div className="flex flex-col gap-6 lg:mx-auto lg:w-3/4" >
                                <h3 className="text-white font-Syne font-bold text-2xl lg:text-3xl">
                                    Project Story
                                </h3>
                                <p className="text-[#949494] lg:text-lg leading-relaxed">
                                    {proj.describtion}
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
                                {id > 1 && <Link to={`/project-details/${+id - 1}`} className="me-auto flex items-center gap-5 text-sm lg:text-base text-white uppercase">
                                    <svg width="50" height="13" viewBox="0 0 50 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {id < projects.length && <Link to={`/project-details/${+id + 1}`} className="ms-auto flex items-center gap-5 text-sm lg:text-base text-white uppercase">
                                    next Project
                                    <svg width="50" height="13" viewBox="0 0 50 13" fill="none" xmlns="http://www.w3.org/2000/svg">
